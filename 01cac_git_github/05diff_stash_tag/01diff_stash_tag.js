/*
    *** Diff, Stash and Tags ***
        This guide will help you understand the different commands related to diff, tags 
        and stash in git. These are not main stream commands but they are very useful in 
        certain situations.
    ...
    *** Git diff ***
        ...
        Git consider the changed versions of same file as two different files. Then it gives names 
        to these two files and shows the differences between them.
        ...
        Git will show you the changes made in the file A and file B. 
        It will also show you the line number where the change occurred along with little preview 
        of the change.
    ...
    *** Comparing Working Directory and Staging Area ***
        ...
        This command alone will not show you the changes made in the file A and file B, 
        you need to provide options to show the changes.
    ...
    *** Git Stash ***
        ...
        It’s useful when switching branches without losing work. 
    ...
    *** Apply Specific Stash ***
        ...
        Here stash@{0} is the name of the stash. You can use the git stash list command to get the 
        name of the stash.
    ...
    *** Git Tags ***
        ...
        They are useful when you want to remember a specific version of your code or when 
        you want to refer to a specific commit. Tags are like sticky notes that you can 
        attach to your commits.

        They are specially used while releasing certain version of product by giving special message
        for some commits, used by the product manager, developers don't use them often.
    ...
    *** Creating a tag ***
        ...
        This command creates a new tag with the specified name. 
    ...
    *** Conclusion ***
        In this section, we explored how to use Git’s diff, stash, and tags commands. 
        Though not used as frequently as add, commit, or push, they are incredibly helpful 
        in debugging, context switching, and release management. See you next tutorial.
*/